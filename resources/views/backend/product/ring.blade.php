      ...
      <div class="cont-info valign">
        <div class="text-center full-width">
          ...
          <div class="item mt-30">
            <h5> Bangalore B1045, <br> Pal, CA 14301 </h5>
          </div>
    ...
    <div id="smooth-content">
      ...
      <div class="hero-banner inner-banner ring-banner">
        ...
        <a href="#" class="buy-btn" title="buy_now">Buy Now</a>
            ...
            <div class="banner-button mt-5" data-aos="fade-right" data-aos-delay="1000">
              <a href="{{ route('product-grids') }}" class="buy-btn" title="buy_now">Buy Now</a>
            </div>
      ...
      <footer class="footer">
        ...
        <svg class="footer-svg" preserveAspectRatio="none" viewBox="0 24 150 28" xmlns="http://www.w3.org/2000/svg"
