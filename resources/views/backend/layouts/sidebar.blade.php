<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
     ...
     <!-- specialty -->
     <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#specialtyCollapse" aria-expanded="true" aria-controls="specialtyCollapse">
          <i class="fas fa-sitemap"></i>
          <span>Specialty</span>
        </a>
        <div id="specialtyCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Specialty Options:</h6>
            <a class="collapse-item" href="{{route('specialty.index')}}">Specialty</a>
            <a class="collapse-item" href="{{route('specialty.create')}}">Add Specialty</a>
          </div>
        </div>
    </li>
    {{-- Products --}}
