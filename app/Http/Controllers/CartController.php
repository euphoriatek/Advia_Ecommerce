...
class CartController extends Controller
{
    ...
    public function singleAddToCart(Request $request){
        ...
        $request->validate([
            'slug' => 'required',
            'quant' => 'required|integer|min:1', // Ensure quantity is an integer and at least 1
        ]);
        ...
        if ($already_cart) {
            ...
            $newQuantity = $already_cart->quantity + $request->quant[1];
            ...
            $already_cart->amount = ($product->price * $newQuantity);
            $already_cart->save();
